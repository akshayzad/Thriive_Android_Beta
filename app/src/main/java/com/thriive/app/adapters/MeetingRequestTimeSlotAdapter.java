...
public class MeetingRequestTimeSlotAdapter extends RecyclerView.Adapter<MeetingRequestTimeSlotAdapter.RecyclerAdapterHolder> {
    ...
    public MeetingRequestTimeSlotAdapter(Context context, Fragment fragment, ArrayList<CommonRequestTimeSlots.EntitySlotsListPOJO> childArrayList, String date){
    ...
    public void onBindViewHolder(final RecyclerAdapterHolder holder, int position) {
        ...
        if (item.isIs_disabled()){
            ...
            if (currentItem == position) {
                ...
                holder.card_slots.setBackground(context.getResources().getDrawable(R.drawable.background_slots));
            }
