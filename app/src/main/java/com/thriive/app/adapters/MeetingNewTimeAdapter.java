...
public class MeetingNewTimeAdapter extends RecyclerView.Adapter<MeetingNewTimeAdapter.RecyclerAdapterHolder> {
    ...
    public MeetingNewTimeAdapter(Context context, Fragment fragment, ArrayList<MeetingDetailPOJO> childArrayList){
        this.context = context;
        this.fragment = fragment;
        this.childArrayList = childArrayList;
    }
    @Override
    public MeetingNewTimeAdapter.RecyclerAdapterHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_overview_selected_slot, parent, false);

        return new MeetingNewTimeAdapter.RecyclerAdapterHolder(itemView);
    }

    @SuppressLint("NewApi")
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    @Override
    public void onBindViewHolder(final MeetingNewTimeAdapter.RecyclerAdapterHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((MeetingsFragment) fragment).acceptMeetingNewTime(item);
