...
public class NotificationFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sharedData = new SharedData(getActivity().getApplicationContext());
        loginPOJO = Utility.getLoginData(getActivity().getApplicationContext());
        ...
        if (bundle != null) {
            if (getArguments().getString("intent_type") != null) {
                if (getArguments().getString("intent_type").equals("NOTI")) {
...
//            cleverTap.pushEvent(Utility.Meeting_Request_Viewed,visitEvent);
                    ...
                    getArguments().remove("intent_type");
                        ...
                        try {
                            ...
                            if (reasonPOJO.getOK()) {
                                if (reasonPOJO.getMeetingList() != null) {
                                    ...
                                    //rv_notification.setAdapter(new PendingNotificationAdapter(getActivity(),requesterPOJOArrayList ));
                                }
                                get_awaited_meetings_for_giver();
                            } else {
                                Toast.makeText(getActivity().getApplicationContext(), " " + reasonPOJO.getMessage(), Toast.LENGTH_SHORT).show();
                            }
...
//                    .show();
                            ...
                            if (reasonPOJO.getOK()) {
                                if (requesterPOJOArrayList != null) {
                                    ...
                                    if (requesterPOJOArrayList.size() > 0) {
                                        ...
                                        rv_notification.setAdapter(new PendingNotificationAdapter(getActivity(), NotificationFragment.this, requesterPOJOArrayList));
                                    } else {
    ...
    private void getMeetingRequestById() {
        try {
            ...
            Call<CommonMeetingPOJO> call = apiInterface.getMeetingById(sharedData.getStringData(SharedData.API_URL) + "api/Meeting/get-meeting", loginPOJO.getActiveToken(),
                    getActivity().getIntent().getStringExtra("meeting_id"));
                        ...
                        try {
                            ...
                            if (pojo != null) {
                                if (pojo.getOK()) {
                                    ...
                                    Toast.makeText(getActivity().getApplicationContext(), " " + pojo.getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            }
                        } catch (Exception e) {
                            e.getMessage();
    ...
    public void detailsMeeting(CommonMeetingListPOJO.MeetingListPOJO meetingListPOJO) {
        ...
        try {
            ...
            dialogMeetingDetails = new BottomSheetDialog(getActivity());
            ...
            bottomSheet.setBackground(getActivity().getResources().getDrawable(R.drawable.rounded_white));
            ...
            if (meetingListPOJO.getRequestorPicUrl().equals("")) {
                Typeface typeface = ResourcesCompat.getFont(getActivity().getApplicationContext(), R.font.roboto_medium);
...
//                        .buildRound(""+meetingListPOJO.getGiverName().charAt(0), R.color.darkGreyBlue);
            ...
            rv_expertise.setAdapter(new MeetingSelectTagAdapter(getActivity(), final_array,
                    (ArrayList<String>) meeting_tag_array));
            ...
            if (meetingListPOJO.getMeetingTag().size() > 0) {
                ...
                if (requesterPOJOArrayList.size() > 0) {
                    ...
                    rv_meetin_tag.setAdapter(new NotificationDetailTagAdapter(getActivity(), requesterPOJOArrayList));
                }
            ...
            img_close.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if (getActivity().getIntent().getStringExtra("intent_type").equals("NOTI")) {
                        if (preciseCountdown != null) {
                            preciseCountdown.cancel();
                        }
                        dialogMeetingDetails.dismiss();
            ...
            if (meetingListPOJO.getSlot_list().size() > 0) {
                rv_slots.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.HORIZONTAL, false));
                rv_slots.setAdapter(new MeetingAcceptSlotAdapter(getActivity(), NotificationFragment.this,
                        ...
                        if (pojo != null) {
                            ...
                            if (pojo.getOK()) {
                                if (pojo.getSlotsListPOJOS().size() > 0) {
                                    ...
                                    ProposeNewTimeSlotAdapter meetingRequestTimeSlotAdapter = new ProposeNewTimeSlotAdapter(getActivity(), NotificationFragment.this,
...
//                    rv_time_slots.setLayoutManager(new GridLayoutManager(getActivity(), 3));
                    ...
                    SelectedProposeSlotAdapter meetingRequestTimeSlotAdapter = new SelectedProposeSlotAdapter(getActivity(),
                            NotificationFragment.this, (ArrayList<CommonRequestTimeSlots.EntitySlotsListPOJO>) slotsListPOJOS);
...
//        }
//
//        SlotListAdapter adapter  = new SlotListAdapter(getActivity(),
        ...
        btn_confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Utility.getCheckSlotTime(startTime)) {
                    Toast.makeText(getActivity().getApplicationContext(), "Please choose current or future time.", Toast.LENGTH_SHORT).show();
                } else {
                        ...
                        try {
                            ...
                            if (reasonPOJO != null) {
                                if (reasonPOJO.getOK()) {
                                    ...
                                    //.makeText(getActivity().getApplicationContext(), "Success "+reasonPOJO.getMessage(), Toast.LENGTH_SHORT).show();
