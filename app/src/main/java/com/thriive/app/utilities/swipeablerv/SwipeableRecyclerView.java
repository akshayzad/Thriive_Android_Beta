package com.thriive.app.utilities.swipeablerv;
    ...
    private void createSwipedView(@NonNull Context context, AttributeSet attrs) {
        ...
        mSwipedView.setBackrounds(new int[]{
                typedArray.getResourceId(
                        R.styleable.SwipeableRecyclerView_leftBgColor, R.color.whiteTwo),
                typedArray.getResourceId(
                        R.styleable.SwipeableRecyclerView_rightBgColor, R.color.whiteTwo)
        });
        mSwipedView.setIcons(new int[]{
                typedArray.getResourceId(
        ...
        mSwipedView.setTextSize((int) typedArray
                .getDimension(R.styleable.SwipeableRecyclerView_textSized, 15f));
    }
