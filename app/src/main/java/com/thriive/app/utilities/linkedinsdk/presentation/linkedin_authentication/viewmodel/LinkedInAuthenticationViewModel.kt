package com.thriive.app.utilities.linkedinsdkutil.linkedinsdk.presentation.linkedin_authentication.viewmodel
...
class LinkedInAuthenticationViewModel(
    ...
    fun onAuthorizationTokenGranted(authorizationToken: String) {
        ...
        executors.networkIO().execute {
            ...
            if (initializationInfo.accessTokenOnlyRequest) {
                executors.mainThread().execute {
