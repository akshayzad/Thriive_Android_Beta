...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, @Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            strokeColor = a.getColor(R.styleable.CircleImageView_civ_border_color, Color.TRANSPARENT);
            strokeWidth = a.getDimensionPixelSize(R.styleable.CircleImageView_civ_border_width, 0);
